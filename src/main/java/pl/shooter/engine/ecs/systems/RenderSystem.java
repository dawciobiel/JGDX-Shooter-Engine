...
public class RenderSystem extends GameSystem {
    ...
    private void renderProceduralMap(ProceduralMap map) {
        float startX = camera.position.x - camera.viewportWidth / 2 - ProceduralMap.TILE_SIZE;
        float startY = camera.position.y - camera.viewportHeight / 2 - ProceduralMap.TILE_SIZE;
        float endX = camera.position.x + camera.viewportWidth / 2 + ProceduralMap.TILE_SIZE;
        float endY = camera.position.y + camera.viewportHeight / 2 + ProceduralMap.TILE_SIZE;
