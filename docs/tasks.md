...
- [ ] **System Dialogów / Komunikatów** (Możliwość wyświetlenia tekstu po wejściu w strefę lub interakcji)
...
- [x] **System Ciał i Krwi (Corpse System)** (Ciała ne znikają natychmiast, efekt fade-out, konfigurowalny kolor krwi)
